...
| 8 | **EFX parameter slots** | Which Patch Common byte each algorithm's front-panel parameter occupies, and its raw-to-display conversion | [`PHASE_4_EFFECT_ROUTING.md`](PHASE_4_EFFECT_ROUTING.md) § Remaining EFX slot evidence, steps 1–6 | Phase 4 M2 close | **Partly 2026-09-04**: 03:DISTORTION and 02:OVER-DRIVE fully mapped, byte for byte identical, Pan displaced to byte 2 in both. They share a control list, so this cannot yet tell whether a control's slot is global or per control-set; an algorithm with a different list containing Pan settles it. Range coverage thin, no displayed value read, conversions untested. 2 algorithms of 40. |
