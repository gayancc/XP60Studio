...
const std::array<ParameterDescriptor, 128> kToneRows{{
    ...
    ParameterDescriptor{"tone.lfo1_waveform", "LFO1 Waveform", 45, ParameterEncoding::SevenBit, 1, 0, 7, 0, 1, DisplayStyle::Number, "", std::span<const std::string_view>(kLabels22), "LFO1", VerificationStatus::DocumentationDerived, "MIDI Implementation p.224"},
    ...
    ParameterDescriptor{"tone.lfo2_waveform", "LFO2 Waveform", 53, ParameterEncoding::SevenBit, 1, 0, 7, 0, 1, DisplayStyle::Number, "", std::span<const std::string_view>(kLabels22), "LFO2", VerificationStatus::DocumentationDerived, "MIDI Implementation p.224"},
