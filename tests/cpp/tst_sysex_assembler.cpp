...
private slots:
    void completeSysExPassesThrough()
    {
        ...
        Collector out;
        const MidiBytes msg{0xF0, 0x41, 0x10, 0x00, 0x6A, 0x12, 0x03, 0x00, 0x00, 0x00, 0x41, 0x3C, 0xF7};
    ...
    void byteAtATime()
    {
        SysExAssembler assembler;
        Collector out;
        const MidiBytes msg{0xF0, 0x41, 0x10, 0x00, 0x6A, 0x11, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x71, 0xF7};
    ...
    void longSysExOfSeveralKilobytes()
    {
        SysExAssembler assembler;
        Collector out;
        MidiBytes big{0xF0, 0x41, 0x10, 0x00, 0x6A, 0x12};
